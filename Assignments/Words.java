 ...
 * arrlst. The length of each string in arrlst is stored into str_len. 
 ...
 * Working/Untested. Code Compiles, issues are undetermined
 * 
...
public class Words{
	 ...
	 * number of strings, stores the length of each string into str_len and
